...
public class TokyoBetterChat extends Module {
    ...
    private void stripFancy(Text text) {
        ...
        if (text instanceof MutableText mutableText && mutableText.getContent() instanceof Literal literalTextContent) {
            ...
            ((IMutableText) mutableText).tokyo$setContent(new Literal(sb.toString()));
        }
    }
}
